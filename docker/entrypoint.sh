...
if [ ! -f "sites/$SITE_NAME/site_config.json" ]; then
  echo "Site $SITE_NAME not found. Initializing new site..."
  ...
  echo "Existing site found. Running database migrations..."
...
echo "Site setup complete. Handing over to Supervisor..."
